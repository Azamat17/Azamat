...
public class DBUtility {
    ...
    public static void openConnection(DBType dbType)throws SQLException {
        ...
        switch (dbType){
            case ORACLE:
                connection = DriverManager.getConnection(Config.getProperty("cybertekTrainingDB.url"),
                        Config.getProperty("cybertekTrainingDB.user"), Config.getProperty("cybertekTrainingDB.password"));
                break;
