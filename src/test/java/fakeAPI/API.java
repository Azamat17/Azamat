...
public class API {
    ...
    user must have name, user must have username, user must have a password;
    */
    ...
    public static List<User> getUsers(String url){
        ...
        String exptectedURL = "api.test.com/user/all";
        if(!url.equals(exptectedURL)){
            System.out.println("404 - Resource Not Found");
            return null;
        }
        System.out.println("200 - OK");
        return DB.getUsers("hello312");
    }
